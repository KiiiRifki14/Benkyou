...
const n2GrammarPool = [
    {
        ...
        a: "よって",
        explanation: "~ni yotte berarti tergantung pada.",
    },
    {
        q: "忙しい_____、つい忘れてしまった。",
        options: ["あまり", "だけ", "からには", "ことか"],
        a: "あまり",
        explanation: "amari berarti saking (berlebihan).",
    },
    {
        q: "言った_____、責任を取りなさい。",
        options: ["からには", "おかげで", "せいか", "うえで"],
        a: "からには",
        explanation: "kara ni wa berarti karena sudah (maka harus).",
    },
    {
        q: "話し合いの_____、決定します。",
        options: ["うえで", "したで", "なかで", "あとで"],
        a: "うえで",
        explanation: "ue de berarti setelah melakukan sesuatu.",
    },
    {
        q: "彼は知っている_____、教えてくれない。",
        options: ["くせに", "からに", "ゆえに", "がてら"],
        a: "くせに",
        explanation: "kuse ni berarti padahal (bernuansa negatif).",
    },
    {
        q: "お金がない_____、旅行をあきらめた。",
        options: ["ゆえに", "だけあって", "からして", "にすぎない"],
        a: "ゆえに",
        explanation: "yue ni berarti oleh karena (formal).",
    },
    {
        q: "あの人の話し方_____、怒っているようだ。",
        options: ["からして", "からすると", "からには", "A dan B"],
        a: "A dan B",
        explanation: "kara shite / kara suru to berarti dilihat dari.",
    },
    {
        q: "努力した_____、成功するわけではない。",
        options: ["からといって", "からには", "からして", "からこそ"],
        a: "からといって",
        explanation: "kara to itte berarti hanya karena... (belum tentu).",
    },
    {
        q: "彼を_____、この仕事はできない。",
        options: ["ぬきにして", "ともかく", "はざておき", "かぎりに"],
        a: "ぬきにして",
        explanation: "nuki ni shite berarti tanpa (dia).",
    },
    {
        q: "病気_____、無理をしないでください。",
        options: ["がちだから", "ぎみだから", "だらけだから", "っぽいだから"],
        a: "ぎみだから",
        explanation: "gimi berarti agak/gejala.",
    },
];

const n2VocabList = [
    { kanji: "矛盾", romaji: "mujun", id: "Kontradiksi" },
    { kanji: "把握", romaji: "haaku", id: "Memahami" },
    { kanji: "検討", romaji: "kentou", id: "Pertimbangan" },
    { kanji: "妥協", romaji: "dakyou", id: "Kompromi" },
    { kanji: "貢献", romaji: "kouken", id: "Kontribusi" },
    { kanji: "犠牲", romaji: "gisei", id: "Pengorbanan" },
    { kanji: "錯覚", romaji: "sakkaku", id: "Ilusi/Salah sangka" },
    { kanji: "頻繁", romaji: "hinpan", id: "Sering" },
    { kanji: "柔軟", romaji: "juunan", id: "Fleksibel" },
    { kanji: "慎重", romaji: "shinchou", id: "Hati-hati" },
    { kanji: "詳細", romaji: "shousai", id: "Detail" },
    { kanji: "偶然", romaji: "guuzen", id: "Kebetulan" },
];

const n1GrammarPool = [
    {
        q: "これ_____、本日の会議を終了します。",
        options: ["をもちまして", "にあたって", "をかわきりに", "にそくして"],
        a: "をもちまして",
        explanation: "o mochimashite = dengan ini (formal).",
    },
    {
        q: "努力の賜物_____。",
        options: [
        ...
        a: "にほかならない",
        explanation: "ni hoka naranai = tidak lain adalah.",
    },
    {
        q: "彼は経営者_____、研究者でもある。",
        options: ["にして", "たるもの", "であれ", "とあって"],
        a: "にして",
        explanation: "ni shite = sekaligus.",
    },
    {
        q: "承認を_____、実行できない。",
        options: ["経ることなしに", "経たうえで", "経たからには", "経ずして"],
        a: "経ることなしに",
        explanation: "heru koto nashi ni = tanpa melalui.",
    },
    {
        q: "あんな事を言う_____。",
        options: ["まじきことだ", "べからざることだ", "A dan B", "はずがない"],
        a: "A dan B",
        explanation: "majiki / bekarazaru = tidak pantas/tidak boleh.",
    },
    {
        q: "雨_____、試合は続行された。",
        options: ["をものともせず", "をよそに", "をかわきりに", "をめぐって"],
        a: "をものともせず",
        explanation: "o mono to mo sezu = tanpa menghiraukan.",
    },
    {
        q: "親の期待_____、遊び呆けている。",
        options: ["をよそに", "にこたえて", "にそって", "にふまえて"],
        a: "をよそに",
        explanation: "o yoso ni = mengabaikan.",
    },
    {
        q: "あの政治家の言葉は、嘘_____。",
        options: ["まみれだ", "だらけだ", "ずくめだ", "っぷりだ"],
        a: "まみれだ",
        explanation: "mamire / darake = penuh dengan (hal buruk).",
    },
    {
        q: "彼のこと_____、また遅刻するだろう。",
        options: ["だから", "ゆえに", "からして", "とはいえ"],
        a: "だから",
        explanation: "dakara = karena karakternya begitu.",
    },
    {
        q: "知っていた_____、言えなかった。",
        options: ["とはいえ", "からには", "ばかりに", "ところで"],
        a: "とはいえ",
        explanation: "to wa ie = meskipun demikian.",
    },
];

const n1VocabList = [
    { kanji: "隠蔽", romaji: "inpei", id: "Penyembunyian" },
    { kanji: "払拭", romaji: "fusshoku", id: "Menghilangkan" },
    { kanji: "懸念", romaji: "kenen", id: "Kekhawatiran" },
    { kanji: "推進", romaji: "suishin", id: "Pendorong" },
    { kanji: "撤回", romaji: "tekkai", id: "Penarikan" },
    { kanji: "模索", romaji: "mosaku", id: "Meraba-raba/Mencari" },
    { kanji: "誘発", romaji: "yuuhatsu", id: "Memicu" },
    { kanji: "逸脱", romaji: "itsudatsu", id: "Penyimpangan" },
    { kanji: "踏襲", romaji: "toushuu", id: "Mengikuti jejak" },
    { kanji: "網羅", romaji: "moura", id: "Mencakup semua" },
    { kanji: "喚起", romaji: "kanki", id: "Membangkitkan" },
    { kanji: "駆使", romaji: "kushi", id: "Menggunakan dengan bebas" },
];
...
function generateLevelQuestions(
    ...
    selectedItems.forEach((item, index) => {
        ...
        if (item.type === "vocab") {
            ...
            const wrong = shuffleSeed(vocabList, qSeed++).filter(
                (v: any) => v.kanji !== word.kanji,
            );
            ...
            if (variation === 0) {
                ...
                questions.push({
                    ...
                    options: shuffleSeed(
                        [word.id, wrong[0].id, wrong[1].id, wrong[2].id],
                        qSeed++,
                    ),
                    answer: word.id,
            ...
            if (variation === 0) {
                ...
                const wrongL = shuffleSeed(grammarPool, qSeed++)
                    .filter((v: any) => v.a !== g.a)
                    .map((v: any) => v.a);
                // Ensure we have enough wrong options
                const validWrongL =
                    wrongL.length >= 3 ? wrongL : ["A", "B", "C"];
                questions.push({
                    type: "listening",
                    category: "Listening",
                    ...
                    speechLang: "ja-JP",
                    options: shuffleSeed(
                        [g.a, validWrongL[0], validWrongL[1], validWrongL[2]],
                        qSeed++,
                    ),
                    answer: g.a,
                ...
                const wrongRG = shuffleSeed(grammarPool, qSeed++)
                    .filter((v: any) => v.a !== g.a)
                    .map((v: any) => v.a);
                const validWrongRG =
                    wrongRG.length >= 3 ? wrongRG : ["A", "B", "C"];
                questions.push({
                    type: "reading",
                    category: "Reading",
...
function generateLevelsConfig(
    ...
    for (let i = 1; i <= totalLevels; i++) {
        ...
        let levelQuestions = generateLevelQuestions(
            grammarPool,
            vocabList,
            countPerLevel,
            seed,
        ...
        levels.push({
            ...
            description: `Tantangan ${prefix} Level ${i} - ${countPerLevel} soal seru bacaan, huruf, dan tatabahasa.`,
            passingScore: 70,
...
export const certificationCategories: CertificationCategory[] = [
    {
        ...
        title: "Level 1: Kohai 🌱",
        description:
            "Langkah pertama yang seru! Bisa baca menu Sushi~ Lulus semua tantangan untuk tema bunga Sakura!",
    ...
    {
        id: "n4",
        title: "Level 2: Senpai ⚡",
        description:
            "Makin jago! Berani pesen Takoyaki sendiri~ Tema Hadiah: Matcha Latté!",
    ...
    },
    {
        ...
        description: "Paham lirik lagu J-Pop! 🎵 Tema Hadiah: Gunung Fuji.",
    ...
    {
        id: "n2",
        title: "Level 4: Tensai 🧠",
        description: "Siap nonton Anime tanpa Subtitle! 📺 Tema Hadiah: Autumn",
    ...
    {
        id: "n1",
        title: "Level 5: Shogun 👑",
        description:
            "Siap diajak jalan-jalan ke Jepang! ✈️ Tema Hadiah: Midnight",
