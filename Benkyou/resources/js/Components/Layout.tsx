    ...
    return (
        <div className="flex h-screen overflow-hidden" style={{ background: isAdminRoute ? '#f1f5f9' : 'var(--color-washi)' }}>
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
                {/* Mobile Header */}
                <div className={`lg:hidden backdrop-blur-md border-b p-4 flex items-center justify-between sticky top-0 z-30 shadow-sm ${isAdminRoute ? 'bg-[#0f172a] border-white/10' : 'bg-white/80 border-[#E5E5E5]'}`}>
