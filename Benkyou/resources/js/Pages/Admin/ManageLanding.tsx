            ...
            <div className="p-6 lg:p-10 max-w-5xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                    <div className="flex flex-wrap border-b border-slate-100 bg-slate-50/50">
                        {["hero", "program_tabs", "visibility", "other"].map(
                            (tab) => (
                                <button
                                    key={tab}
                    ...
                    <div className="p-6 lg:p-8">
                        {activeTab === "hero" && (
                            ...
                            >
                                {renderInput(
                                    "hero_badge",
                                    "Badge Teks Atas (contoh: Yuk Belajar Bareng!)",
                                )}
                                {renderInput(
                                    "hero_title",
                                    "Judul Utama (bisa pakai HTML <span> untuk warna merah)",
                                )}
                                {renderInput(
                                    "hero_subtitle",
                                    "Sub-Judul (Deskripsi bawah judul)",
                                    "textarea",
                                )}
                                {renderInput(
                                    "hero_cta_text",
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {[1, 2, 3].map((num) => (
                                        <div
                                            key={num}
                                            className="p-4 border border-slate-200 rounded-2xl space-y-2 bg-white"
                                        >
                                            <h4 className="font-bold text-indigo-600 mb-3 border-b pb-2">
                                                Konten Tab {num}
                                            </h4>
                                            {renderInput(
                                                `tab${num}_name` as any,
                                                "Nama Tab (Tombol)",
                                            )}
                                            {renderInput(
                                                `tab${num}_title` as any,
                                                "Judul Tab",
                                            )}
                                            {renderInput(
                                                `tab${num}_subtitle` as any,
                                                "Sub-judul/Kutipan",
                                            )}
                                            {renderInput(
                                                `tab${num}_desc1` as any,
                                                "Deskripsi 1",
                                                "textarea",
                                            )}
                                            {renderInput(
                                                `tab${num}_desc2` as any,
                                                "Deskripsi 2",
                                                "textarea",
                                            )}
                                            {renderInput(
                                                `tab${num}_stats` as any,
                                                "Poin (pisahkan dengan •)",
                                            )}
                                        </div>
                                    ))}
                                </div>
                        ...
                        {activeTab === "visibility" && (
                            ...
                            >
                                <p className="text-sm text-slate-500 mb-4">
                                    Nyalakan atau matikan setiap bagian di
                                    halaman landing. Bagian yang dimatikan tidak
                                    akan muncul untuk pengunjung.
                                </p>
                                {[
                                    {
