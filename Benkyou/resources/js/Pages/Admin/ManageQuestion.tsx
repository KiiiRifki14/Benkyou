...
export default function ManageQuestion({
    ...
    const filteredQuestions = questionsData.filter((q) => {
        ...
        const matchesCategory =
            ...
            q.type.toLowerCase() === activeCategory.toLowerCase();
        const matchesQuestionType =
            activeQuestionType === "semua" ||
            q.question_type.toLowerCase() === activeQuestionType.toLowerCase();
    ...
    const totalPages = Math.max(
        1,
        Math.ceil(filteredQuestions.length / ROWS_PER_PAGE),
    );
    ...
    const openCrud = (mode: "add" | "edit", item?: Question) => {
        ...
        if (mode === "edit" && item) {
            ...
            try {
                const rawAns =
                    typeof item.answer === "string"
                        ...
                        : item.answer;
                parsedAnswer = Array.isArray(rawAns)
                    ? rawAns.join(", ")
                    : rawAns || "";
            } catch (e) {
            ...
            setQuestionForm({
                ...
                extra_attributes: {
                    essay_keywords:
                        item.extra_attributes?.essay_keywords?.join(", ") || "",
    ...
    const handleCrudSubmit = (e: React.FormEvent) => {
        ...
        if (
            ...
            questionForm.context.trim() === ""
        ) {
            window.alert(
                "Untuk soal reading, isi Konteks / Paragraf Bacaan terlebih dahulu.",
            );
            return;
        }
        ...
        if (
            ...
            window.alert(
                "Masukkan minimal 2 pilihan jawaban untuk soal pilihan ganda atau reading.",
            );
            return;
        }
        ...
        let finalExtra = {
            ...
            essay_keywords: questionForm.extra_attributes.essay_keywords
                .split(",")
                .map((s) => s.trim())
                .filter((s) => s),
        };
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-0.5">
                        Tambah, ubah, dan hapus pertanyaan kuis latihan harian
                        dan misi petualangan.
                    </p>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 text-slate-400 text-[11px] font-bold uppercase tracking-wider border-b border-slate-100">
                                <th className="py-3.5 px-6 w-1/2">
                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p className="text-slate-400 text-sm font-medium">
                                            Tidak ada data Pertanyaan yang
                                            ditemukan.
                                        </p>
                                        <button
                                            onClick={() => openCrud("add")}
                    ...
                    >
                        ...
                        >
                            ...
                            <form
                                ...
                                className="p-6 overflow-y-auto space-y-4 bg-white flex-1"
                            >
                                ...
                                {questionForm.question_type === "essay" && (
                                    <div className="p-4 bg-orange-50 rounded-xl border border-orange-100 space-y-4 mt-2">
                                        <h4 className="text-orange-800 font-bold">
                                            Konfigurasi Penilaian Esai (Gemini
                                            AI)
                                        </h4>
                                        <div>
                                            <label className="text-xs font-bold uppercase tracking-wider text-orange-600 block mb-1">
                                                Kata Kunci Utama (Pisahkan
                                                dengan koma)
                                            </label>
                                            <input
                                                type="text"
                                ...
                                {questionForm.question_type !== "essay" && (
                                    <div>
                                        <label className="text-xs font-bold uppercase tracking-wider text-slate-500 block mb-1">
                                            ...
                                            "typing"
                                                ? "Jawaban Benar (Gunakan koma jika ada beberapa kemungkinan)"
                                                : "Jawaban Benar (Harus persis sama dengan salah satu pilihan)"}
                                        </label>
                                        <input
                                            type="text"
                                            required
                    ...
                    >
                        ...
                        >
                            <div className="p-6 text-center space-y-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-slate-800 text-lg">
                                        Hapus Soal Pertanyaan?
                                    </h3>
                                    <p className="text-sm text-slate-500 mt-1">
                                        Apakah Anda yakin ingin menghapus
                                        pertanyaan ini? Tindakan ini tidak dapat
                                        dibatalkan.
                                    </p>
