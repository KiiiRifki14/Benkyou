...
export const THEMES = {
    default: {
        id: "default",
        name: "Original (Klasik)",
        props: {
            "--color-washi": "#F5F2EB",
            "--color-ink": "#1C1C1C",
            "--color-ink-light": "#4A4A4A",
            "--color-japan-red": "#BE0029",
            "--color-sakura": "#FFB7C5",
            "--color-matcha": "#C5E1A5",
        },
    },
    sakura: {
        id: "sakura",
        name: "Mekar Sakura (N5)",
        props: {
            "--color-washi": "#FFF0F5",
            "--color-ink": "#2D1B2E",
            "--color-ink-light": "#5A465B",
            "--color-japan-red": "#D87093",
            "--color-sakura": "#FFB7C5",
            "--color-matcha": "#C5E1A5",
        },
    },
    matcha: {
        id: "matcha",
        name: "Hijau Matcha (N4)",
        props: {
            "--color-washi": "#F1F8E9",
            "--color-ink": "#1B2E1C",
            "--color-ink-light": "#465B47",
            "--color-japan-red": "#689F38",
            "--color-sakura": "#FFB7C5",
            "--color-matcha": "#AED581",
        },
    },
    fuji: {
        ...
        props: {
            "--color-washi": "#E3F2FD",
            "--color-ink": "#0D47A1",
            "--color-ink-light": "#42A5F5",
            "--color-japan-red": "#1565C0",
            "--color-sakura": "#BBDEFB",
            "--color-matcha": "#81D4FA",
        },
    },
    autumn: {
        ...
        props: {
            "--color-washi": "#FFF3E0",
            "--color-ink": "#3E2723",
            "--color-ink-light": "#795548",
            "--color-japan-red": "#E64A19",
            "--color-sakura": "#FFCC80",
            "--color-matcha": "#FFAB91",
        },
    },
    midnight: {
        ...
        props: {
            "--color-washi": "#1F2229",
            "--color-ink": "#FFFFFF",
            "--color-ink-light": "#B3B3B3",
            "--color-japan-red": "#BB86FC",
            "--color-sakura": "#CE93D8",
            "--color-matcha": "#90CAF9",
        },
    },
...
export default function Themes() {
    ...
    useEffect(() => {
        ...
        const certList: { category: string; passed: boolean }[] =
            userCertifications || [];
    ...
    const handleSelectTheme = (themeId: string) => {
        if (unlocked.includes(themeId)) {
            ...
            // Save to backend
            (window as any).axios
                .post("/student/preferences", { theme_id: themeId })
                .catch((err: any) =>
    ...
    const getThemeLevelText = (id: string) => {
        switch (id) {
            case "sakura":
                return "Selesaikan Level Kohai untuk membuka tema ini.";
            case "matcha":
                return "Selesaikan Level Senpai untuk membuka tema ini.";
            case "fuji":
                return "Selesaikan Level Sensei untuk membuka tema ini.";
            case "autumn":
                return "Selesaikan Level Tensai untuk membuka tema ini.";
            case "midnight":
                return "Selesaikan Level Shogun untuk membuka tema ini.";
            default:
                return "Tersedia sejak awal.";
        }
    };
