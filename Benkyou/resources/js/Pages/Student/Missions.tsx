    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <header className="text-center space-y-4 pt-8">
                <h1 className="font-serif text-4xl font-light">Misi Sertifikasi</h1>
                <p className="text-[var(--color-ink-light)]">Selesaikan setiap level untuk membuktikan kemampuanmu.</p>
            </header>
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <h2 className="text-2xl font-bold text-[var(--color-ink)]">{level.title}</h2>
                                        <p className="text-[var(--color-ink-light)] mt-1">{level.subtitle}</p>
                                    </div>
                                </div>
                                ...
                                <div className="w-full md:w-auto flex flex-col items-end gap-3 mt-4 md:mt-0">
                                    {isUnlocked ? (
                                        ...
                                        >
                                            <GraduationCap size={18} /> {level.passed ? 'Ulangi Ujian' : 'Mulai Ujian'}
                                        </Link>
                                    ) : (
